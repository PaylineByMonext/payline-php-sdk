...
class PaylineSDK
{
    ...
    public function verifyEnrollment(array $array)
    {
        ...
        $WSRequest = array(
            ...
            'merchantName'      => isset($array['merchantName']) ? $array['merchantName'] : null,
            'returnURL'         => isset($array['returnURL']) ? $array['returnURL'] : null,
            'order'             => $order,
            'buyer'             => $buyer,
            'subMerchant'       => $subMerchant,
            'recurring'         => isset($array['recurring']) ? $array['recurring'] : null,
